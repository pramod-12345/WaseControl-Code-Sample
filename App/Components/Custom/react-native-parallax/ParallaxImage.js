...
import {View, Animated, StyleSheet, Dimensions, TouchableOpacity, Image} from 'react-native'
...
export default class ParallaxImage extends Component {
  ...
  render = () => {
    ...
    var height = height || 0;
    var parallaxPadding = (height) * parseFloat(parallaxFactor);

    var parallaxStyle = {
      height: height ? (height + parallaxPadding * 2) : 120,
      width: width ? (!width && 0 || width) : 412,
    };
